...
.method private a()Lorg/chromium/support_lib_boundary/SafeBrowsingResponseBoundaryInterface;
    .locals 3
    ...
    invoke-virtual {v1, v2}, Landroidx/webkit/d/h;->a(Landroid/webkit/SafeBrowsingResponse;)Ljava/lang/reflect/InvocationHandler;
...
.method private b()Landroid/webkit/SafeBrowsingResponse;
    .locals 2
...
.method public a(Z)V
    ...
    invoke-virtual {v0}, Landroidx/webkit/d/d;->a()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-direct {p0}, Landroidx/webkit/d/b;->b()Landroid/webkit/SafeBrowsingResponse;
    ...
    :cond_0
    invoke-virtual {v0}, Landroidx/webkit/d/d;->b()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-direct {p0}, Landroidx/webkit/d/b;->a()Lorg/chromium/support_lib_boundary/SafeBrowsingResponseBoundaryInterface;
