...
.field private final g:Lio/flutter/embedding/android/l$d;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->g:Lio/flutter/embedding/android/l$d;
...
.method static synthetic a(Lio/flutter/embedding/android/FlutterSplashView;)Lio/flutter/embedding/android/l;
    .locals 0

    iget-object p0, p0, Lio/flutter/embedding/android/FlutterSplashView;->b:Lio/flutter/embedding/android/l;
...
.method private a()Z
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->b:Lio/flutter/embedding/android/l;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lio/flutter/embedding/android/l;->f()Z
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/android/l;->getAttachedFlutterEngine()Lio/flutter/embedding/engine/a;
...
.method private c()Z
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/p;->a()Z
...
# virtual methods
.method public a(Lio/flutter/embedding/android/l;Lio/flutter/embedding/android/p;)V
    .locals 2
    ...
    :cond_1
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->b:Lio/flutter/embedding/android/l;
    ...
    invoke-interface {p2, v0, v1}, Lio/flutter/embedding/android/p;->a(Landroid/content/Context;Landroid/os/Bundle;)Landroid/view/View;
    ...
    invoke-virtual {p1, p2}, Lio/flutter/embedding/android/l;->a(Lio/flutter/embedding/engine/h/b;)V
    ...
    invoke-interface {p2, p1, v0}, Lio/flutter/embedding/android/p;->a(Landroid/content/Context;Landroid/os/Bundle;)Landroid/view/View;
    ...
    :cond_3
    invoke-virtual {p1}, Lio/flutter/embedding/android/l;->f()Z
    ...
    invoke-static {p2, v0}, Ld/a/a;->c(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p2, p0, Lio/flutter/embedding/android/FlutterSplashView;->g:Lio/flutter/embedding/android/l$d;

    invoke-virtual {p1, p2}, Lio/flutter/embedding/android/l;->a(Lio/flutter/embedding/android/l$d;)V
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/p;->b()Landroid/os/Bundle;
